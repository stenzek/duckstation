...
retry_command sudo apt-add-repository -n 'deb http://apt.llvm.org/jammy/ llvm-toolchain-jammy-22 main'

retry_command sudo apt-get update
retry_command sudo apt-get -y install \
  build-essential clang-22 cmake curl extra-cmake-modules git libasound2-dev libcurl4-openssl-dev libdbus-1-dev libdecor-0-dev libegl-dev libevdev-dev \
  ...
  libxrandr-dev libxss-dev lld-22 llvm-22 nasm ninja-build patchelf pkg-config zlib1g-dev
