...
/// Auxiliary imgui windows. TODO: Disable this on Android.
...
/// Processes window size messages from the host.
...
/// Auxiliary window management. TODO: Disable this on Android.
