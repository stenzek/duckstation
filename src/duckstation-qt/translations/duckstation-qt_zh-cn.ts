...
<context>
    ...
    <message>
        ...
        <translation>将游戏镜像加载到内存中。对于可能在游戏过程中变得不可靠的网络路径非常有用。在某些情况下, 当游戏开始播放音轨时也可以消除重音。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../controllersettingswidget.cpp" line="51"/>
...
<context>
    ...
    <message>
        ...
        <translation>缩放色彩抖动 (按分辨率缩放抖动模式)</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../gpusettingswidget.ui" line="146"/>
    ...
    <message>
        ...
        <translation>强制输出到控制台的帧缓冲区的颜色精度使用每个通道的全部8位精度。这会产生更好看的渐变, 但代价是使某些颜色看起来稍有不同。禁用该选项也会启用色彩抖动, 这会通过在这些像素周围应用图案来减少颜色之间的过渡。大多数游戏都与此选项兼容, 但也有一部分游戏不支持此选项, 并且在启用该选项后会产生中断效果。仅适用于硬件渲染器。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../generalsettingswidget.ui" line="64"/>
        <source>Apply Per-Game Settings</source>
        <translation>每个游戏单独应用设置</translation>
    </message>
    <message>
        <location filename="../generalsettingswidget.ui" line="65"/>
...
<context>
    ...
    <message>
        ...
        <translation>控制器0/按键圈绑定</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;strong&gt;快捷键设置&lt;/strong&gt;&lt;hr&gt;绑定热键可以触发事件, 例如按下键/控制器按键时重置或截屏。热键标题是不言而喻的。单击绑定将开始倒计时, 在这种情况下, 您应该按要绑定的键或控制器按键/摇杆。如果没有按下任何按键, 计时器超时, 绑定将保持不变。要清除绑定, 请右键单击该按键。若要绑定多个按键, 请按住Shift键并单击该按键。</translation>
    </message>
    <message>
        ...
        <translation>&lt;strong&gt;控制器设置&lt;/strong&gt;&lt;hr&gt;此页允许您选择要为模拟主机的控制器类型, 并将按键或主机游戏控制器按键重新绑定到您选择的位置。单击绑定将开始倒计时, 在这种情况下, 您应该按要绑定的键或控制器按键/摇杆。 (关于震动开关, 请按控制器上的任意按键/摇杆来绑定震动开关。) 如果没有按下任何按键并且计时器超时, 绑定将保持不变。要清除绑定, 请右键单击该按键。若要绑定多个按键, 请按住Shift键并单击该按键。</translation>
    </message>
    <message>
