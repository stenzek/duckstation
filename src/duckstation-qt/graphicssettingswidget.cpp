  ...
  : QWidget(parent), m_dialog(dialog)
{
  ...
  connect(m_ui.renderer, &QComboBox::currentIndexChanged, this, &GraphicsSettingsWidget::onRendererChanged);
...
void GraphicsSettingsWidget::onRendererChanged()
{
  if (m_dialog->isPerGameSettings() || m_ui.renderer->currentIndex() == 0 ||
      Core::GetBaseBoolSettingValue("UI", "RendererWarningShown", false))
  {
    updateResolutionDependentOptions();
    return;
  }
