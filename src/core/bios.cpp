...
static constexpr std::array<ImageInfo, 21> s_image_infos = {{
  ...
  {"DTL-H1100 (v2.2 03-06-96 D)", ConsoleRegion::NTSC_J,
  ...
  {"SCPH-1001, DTL-H1101 (v2.1 07-17-95 A)", ConsoleRegion::NTSC_U, MakeHashFromString("da27e8b6dab242d8f91a9b25d80c63b8")},
