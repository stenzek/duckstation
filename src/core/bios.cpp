...
static constexpr std::array<ImageInfo, 21> s_image_infos = {{
  ...
  {"SCPH-1002, DTL-H1100 (Version 2.2 03/06/96 D)", ConsoleRegion::PAL,
   MakeHashFromString("ca5cfc321f916756e3f0effbfaeba13b")},
  {"SCPH-3000, DTL-H1000H (v1.1 01-22-95)", ConsoleRegion::NTSC_J,
   MakeHashFromString("849515939161e62f6b866f6853006780")},
  {"SCPH-3000, DTL-H1001 (v2.0 05/07/95 A)", ConsoleRegion::NTSC_U,
  ...
  {"SCPH-3500 (DTL-H1101 (Version 2.1 07/17/95 A)", ConsoleRegion::NTSC_U, MakeHashFromString("da27e8b6dab242d8f91a9b25d80c63b8")},
