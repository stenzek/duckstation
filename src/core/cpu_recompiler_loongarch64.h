...
protected:
  ...
  void Compile_dst_op(CompileFlags cf, LaRRROp op, void (LoongArch64Recompiler::*op_const)(la_gpr_t rd, la_gpr_t rs, u32 imm),
...
private:
  ...
  void SwitchToFarCode(bool emit_jump, LaBranchCondition cond = LaBranchCondition::None,
                       la_gpr_t rs1 = LA_ZERO, la_gpr_t rs2 = LA_ZERO);
