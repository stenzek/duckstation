...
const Source* LookupSource(SourceKey key, const GSVector4i uv_rect);
...
GSVector4i GetPageDrawnRect(u32 page_index);
...
void DecodeTexture(const u16* page_ptr, GPUTexturePaletteReg palette, GPUTextureMode mode, u32* dest, u32 dest_stride,
