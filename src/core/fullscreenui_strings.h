...
TRANSLATE_NOOP("FullscreenUI", "All unofficial achievement progress for the current game will be removed. This cannot be undone.");
...
TRANSLATE_NOOP("FullscreenUI", "Applies the selected sprite texture filter to framebuffer uploads. This can smooth backgrounds in some games while preserving texture data and 24-bit video.");
...
TRANSLATE_NOOP("FullscreenUI", "Delete");
...
TRANSLATE_NOOP("FullscreenUI", "Filter Framebuffer Uploads");
...
TRANSLATE_NOOP("FullscreenUI", "Length: {}");
...
TRANSLATE_NOOP("FullscreenUI", "Minimum Framebuffer Upload Height");
TRANSLATE_NOOP("FullscreenUI", "Minimum Framebuffer Upload Width");
TRANSLATE_NOOP("FullscreenUI", "Minimum: {}");
TRANSLATE_NOOP("FullscreenUI", "Move Cursor");
...
TRANSLATE_NOOP("FullscreenUI", "Only filters framebuffer uploads at least this tall. Increase this value to avoid filtering texture data.");
TRANSLATE_NOOP("FullscreenUI", "Only filters framebuffer uploads at least this wide. Increase this value to avoid filtering texture data.");
...
TRANSLATE_NOOP("FullscreenUI", "Reset Unlock");
TRANSLATE_NOOP("FullscreenUI", "Reset Unofficial Achievement");
TRANSLATE_NOOP("FullscreenUI", "Reset Unofficial Achievement Unlocks");
...
TRANSLATE_NOOP("FullscreenUI", "SDL Persistent Device Identifiers");
...
TRANSLATE_NOOP("FullscreenUI", "Saves supported controllers by serial or device identity so bindings survive port and connection-order changes when possible.");
...
TRANSLATE_NOOP("FullscreenUI", "Select Key");
...
TRANSLATE_NOOP("FullscreenUI", "The unlock state for '{}' will be removed. This cannot be undone.");
...
TRANSLATE_NOOP("FullscreenUI", "Toggle Case");
...
TRANSLATE_NOOP("FullscreenUI", "Track Unofficial Achievements");
...
TRANSLATE_NOOP("FullscreenUI", "Unofficial achievement unlock reset.");
TRANSLATE_NOOP("FullscreenUI", "Unofficial achievement unlocks reset.");
...
TRANSLATE_NOOP("FullscreenUI", "Value: {}");
...
TRANSLATE_NOOP("FullscreenUI", "When enabled, DuckStation will track unofficial achievements. Unlocks will be saved locally and not sent to RetroAchievements.");
